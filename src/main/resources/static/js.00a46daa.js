...
},{"./toPropertyKey.js":"../node_modules/@babel/runtime/helpers/toPropertyKey.js"}],"js/grid.js":[function(require,module,exports) {
"use strict";
...
function _fetchGridInfo() {
  _fetchGridInfo = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(gridSize, commaSeperatedWords) {
    var response, result;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return fetch("http://localhost:8080/wordgrid?gridSize=".concat(gridSize, "&wordList=").concat(commaSeperatedWords));
        case 2:
